...
# Wagerr
DEFINES   += COIN_P2PKH_VERSION=73 COIN_P2SH_VERSION=63 COIN_FAMILY=1 COIN_COINID=\"Wagerr\" COIN_COINID_HEADER=\"WAGERR\" COIN_COLOR_HDR=0x3790CA COIN_COLOR_DB=0x9BC8E5 COIN_COINID_NAME=\"Wagerr\" COIN_COINID_SHORT=\"WGR\" COIN_KIND=COIN_KIND_WAGERR
APPNAME ="Wagerr"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
